...
class VMAHungarianAssigner(BaseAssigner):
    ...
    def __init__(self,
        ...
        self.cls_cost = build_match_cost(cls_cost) # 分类损失
        self.reg_cost = build_match_cost(reg_cost) # 回归成本
        self.iou_cost = build_match_cost(iou_cost) 
        self.pts_cost = build_match_cost(pts_cost) # chamfer 距离 关键点成本 python3 tools/test.py projects/configs/vma_trunk_line_two_map_res_later_fusion_att_gram_loss.py  /homes/zhangzijian/vma-dev/new_data_train_result/later_fusion_spatial_gram_loss_res_swin_debug_pt2line12pt2pt2/epoch_96.pth --eval chamfer --eval-option show=True show_dir=visualize_result_fuseres_swinlossimp
    ...
    def assign(self,
        ...
        cls_cost = self.cls_cost(cls_pred, gt_labels) # 预测 和GT 的匹配程度  成本越低 匹配度越高  cls_pred 分类成本  gt_labels 
